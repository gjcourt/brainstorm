...
Write an eBPF program in C that attaches to network interfaces on your homelab nodes to monitor
traffic at the kernel level. Write a Go user-space program to collect the metrics and export them to
Prometheus.
