...
## Description
Set up a local LLM (like Llama 3 or Mistral) on your homelab server using GPU passthrough. Integrate it with Home Assistant's voice pipeline to create a completely private, offline voice assistant.
